...
public class AccueilBack extends Form {
    ...
    private Button makeHebergementsButton() {
        ...
        button.addActionListener(action -> new com.newpidev.gui.back.hebergement.ShowAll(this).show());
        return button;
    }
    private Button makePayssButton() {
        ...
        button.setUIID("buttonMenu");
        //button.setMaterialIcon(FontImage.MATERIAL_BOOKMARK);
        button.addActionListener(action -> new com.newpidev.gui.back.pays.ShowAll(this).show());
        return button;
    }
    private Button makeChauffeursButton() {
        ...
        button.setUIID("buttonMenu");
        //button.setMaterialIcon(FontImage.MATERIAL_BOOKMARK);
        button.addActionListener(action -> new com.newpidev.gui.back.chauffeur.ShowAll(this).show());
        return button;
    }
    private Button makeLocationcsButton() {
        ...
        button.setUIID("buttonMenu");
        //button.setMaterialIcon(FontImage.MATERIAL_BOOKMARK);
        button.addActionListener(action -> new com.newpidev.gui.back.locationc.ShowAll(this).show());
        return button;
    }
      ...
      private Button makeEvenementsButton() {
        ...
        button.setUIID("buttonMenu");
        //button.setMaterialIcon(FontImage.MATERIAL_BOOKMARK);
        button.addActionListener(action -> new com.newpidev.gui.back.evenement.ShowAll(this).show());
        return button;
    }
    ...
    private Button makeReservationsButton() {
        ...
        button.setUIID("buttonMenu");
        //button.setMaterialIcon(FontImage.MATERIAL_BOOKMARK);
        button.addActionListener(action -> new com.newpidev.gui.back.reservation.ShowAll(this).show());
        return button;
    }
      private Button makeDivsButton() {
        ...
        button.setUIID("buttonMenu");
        //button.setMaterialIcon(FontImage.MATERIAL_BOOKMARK);
        button.addActionListener(action -> new com.newpidev.gui.back.div.ShowAll(this).show());
        return button;
    }
    ...
    private Button makeLikesButton() {
        ...
        button.setUIID("buttonMenu");
        //button.setMaterialIcon(FontImage.MATERIAL_BOOKMARK);
        button.addActionListener(action -> new com.newpidev.gui.back.like.ShowAll(this).show());
        return button;
    }
    ...
    private Button makeTypessButton() {
        ...
        button.setUIID("buttonMenu");
        //button.setMaterialIcon(FontImage.MATERIAL_BOOKMARK);
        button.addActionListener(action -> new com.newpidev.gui.back.types.ShowAll(this).show());
        return button;
    }
